 ...
 *                     role-hint="default"
 */
public class PlexusFullProjectClassLoader extends AbstractComponentConfigurator
{

    private static final Logger LOGGER = LoggerFactory.getLogger(PlexusFullProjectClassLoader.class);
